  ...
  return (
    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="min-h-full">
      ...
      <div className="apex-page space-y-7 sm:space-y-9">
        ...
        <section>
          <SectionHeader eyebrow="Sinais principais" title="Consistência por hábito" action={<button onClick={() => onOpenTab?.("habitos")} className="flex min-h-10 items-center gap-1.5 text-[10px] font-semibold text-accent">Detalhar <ArrowRight size={13} /></button>} />
