      ...
      <div className="px-8 py-6 max-w-3xl space-y-6">
        ...
        <div className="bg-apex-surface border border-apex-border rounded-xl px-4 py-3 flex items-start gap-3">
          ...
          <div>
            ...
            <p className="text-[10px] text-apex-faint">Para <strong className="text-apex-muted">planejar a semana e criar templates</strong>, use a aba <strong className="text-apex-muted">Periodização</strong>.</p>
          </div>
        </div>
        ...
        <div className="space-y-2">
          {filtered.length === 0 && (
            <p className="text-[12px] text-apex-faint italic py-6 text-center">Nenhum treino planejado. Adicione na aba Periodização.</p>
          )}
          {filtered.map(w => (
